    ...
    <div className="flex flex-col gap-[16px] h-full">
              ...
              {data.results.map((item: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="text-[#0a0a0a] flex z-[10] justify-center items-center text-[14px] font-[500] w-[24px] h-[24px] rounded-full bg-[#00D9FF] absolute -bottom-[2px] -end-[2px]">
      ...
      <div className="flex justify-end gap-[8px]">
        ...
        <button
          ...
          className="cursor-pointer text-[#0a0a0a] disabled:opacity-80 disabled:cursor-not-allowed h-[52px] px-[20px] items-center justify-center bg-[#00D9FF] flex rounded-[10px] gap-[8px]"
        >
          {importing && (
...
export const ThirdPartyMediaLibrary: FC<{
  ...
  return (
    <button
      ...
      className="cursor-pointer bg-transparent border border-[#00D9FF] text-[#00D9FF] changeColor flex gap-[8px] h-[44px] px-[18px] justify-center items-center rounded-full font-[600] text-[14px] hover:bg-[#00D9FF]/10 transition-colors"
    >
      <svg
        width="14"
        height="14"
