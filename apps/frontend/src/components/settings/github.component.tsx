...
const ConnectedComponent: FC<{
  ...
  return (
    <div className="my-[16px] mt-[16px] h-[90px] bg-sixth border-fifth border rounded-[16px] p-[24px]">
...
const ConnectComponent: FC<{
  ...
  return (
    <div className="my-[16px] mt-[16px] h-[100px] bg-sixth border-fifth border rounded-[16px] px-[24px] flex">
